        ...
        <div>       
            ...
            <div className="flex flex-col">
                <div className="flex relative flex-col items-center pb-28 w-full min-h-[410px] max-md:pb-24 max-md:max-w-full">
                    ...
                    <h1 className="relative mt-28 text-5xl font-bold leading-none text-white max-md:mt-10 max-md:text-4xl">ContactUs</h1>
                    <nav className="flex relative gap-1 mt-5 mb-0 max-w-full text-xl leading-snug whitespace-nowrap w-[137px] max-md:mb-2.5" aria-label="Breadcrumb">
                        ...
                        <Link href='/pages/chefs' className="text-amber-500" aria-current="page">ContactUs</Link>
                    </nav>
                </div>
            </div>
            ...
            <ContactForm />
            {/* Footer */}
            <div className='sm:w-full sm:absolute sm:top-[1400px] md:top-[1400px]'>
                <Footer />
            </div>
        </div>
    );
