  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white p-6 border border-neutral-200 text-center">
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat itaque sit delectus saepe eos totam alias
          dolorum enim cupiditate hic.
        </p>
      </div>
      ...
      <div className="bg-white p-6 border border-neutral-200">
        ...
        {filters.map((filter) => (
          <div key={filter.id} className="flex items-center justify-between gap-4 font-bold text-zinc-800 mb-4">
